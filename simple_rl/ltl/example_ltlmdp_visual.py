...
def ltl_visualiser(model):
    ...
    '''
    from simple_rl.tasks.amdp_3D.cleanup_block import CleanUpBlock
    from simple_rl.tasks.amdp_3D.cleanup_door import CleanUpDoor
    from simple_rl.tasks.amdp_3D.cleanup_room import CleanUpRoom
    from simple_rl.tasks.amdp_3D.cleanup_task import CleanUpTask
    from simple_rl.tasks.amdp_3D.CleanupMDPClass import CleanUpMDP
    '''
